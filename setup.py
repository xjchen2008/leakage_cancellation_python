...
file_rx = 'BPF_Antenna_499999_indoor_40_60MHz_chirp_withPA_antialiasLPF_0529_0.csv'
...
nitt = 5 #12 #20
upsamp_rate = 1
K = 200# 26 # Max delay, filter length, how far you want to cancel
Q = 3 # 10 # Order = 2*Q-1
eta = 0.08
delay_step = 1 # 1 # The step size of time delay for template matrix X in function tx_template()
delay_0 = 0 # 20 # 20 for real measurement using Keysight instrument rader.  #-2000#1000 #-200  # -450 #-480  # The initial cancel location. The initial delay in the matrix X in function tx_template()
