...
N = 8192+1  # This also limit the bandwidth. And this is determined by fpga LUT size.
...
# Create the sine
##################
#y = numpy.sin(2*numpy.pi*fs/N*t)#+ numpy.sin(4*numpy.pi*fs/N*t)# just use LO to generate a LO. The
#yq = numpy.sin(2*numpy.pi*fs/N*t-numpy.pi/2)# + numpy.sin(4*numpy.pi*fs/N*t-numpy.pi/2)
y_cx_0 = y + j * yq
